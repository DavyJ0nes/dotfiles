...
local function augroup(name)
	return vim.api.nvim_create_augroup("davyj0nes_" .. name, { clear = true })
end
...
-- LSP
local completion = vim.g.completion_mode or "blink" -- or 'blink'
	...
	callback = function(args)
		...
		if client then
			...
			if
				...
				and not vim.tbl_contains(inlay_hint_blocklist, client.name)
			then
